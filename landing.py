...
<div class="carousel-section" style="padding: 0; background: transparent;">
    <div class="carousel-container">
        <a href="https://stackteste.streamlit.app/?cliente=template13" target="_blank" style="text-decoration: none;"><div class="carousel-item-image-only"><img src="https://i.postimg.cc/cCTtC2hy/13.png" alt="Template 13"></div></a>
