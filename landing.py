...
with p2: # Featured
    ...
    """, unsafe_allow_html=True)
    st.markdown('<a href="https://pay.kiwify.com.br/qE6dljc" target="_blank" style="display:inline-block; background: linear-gradient(90deg, #7b2cbf, #9d4edd); color: white; border: none; padding: 25px 60px; font-weight: 900; font-size: 22px; text-transform: uppercase; letter-spacing: 2px; border-radius: 0; clip-path: polygon(10% 0, 100% 0, 90% 100%, 0% 100%); text-decoration: none; transition: 0.4s; cursor: pointer; margin-top: 10px;">CRIAR MEU SITE AGORA</a>', unsafe_allow_html=True)
